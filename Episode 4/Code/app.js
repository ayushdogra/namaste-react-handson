...
/*
These are the components of our app
Header
-Logo
-Nav Items
  ...
  return (
    <div className="header">
      <div className="img-container">
        <img src="https://s.tmimgcdn.com/scr/800x500/212900/spoon-and-fork-restaurant-logo_212966-original.png" />
      </div>
  ...
  return(
    <div className="res-card">
      <div className="image-container">
        <img className="card-image" src=" https://hips.hearstapps.com/hmg-prod/images/delish-210419-carne-asada-torta-01-portrait-jg-1620136948.jpg "/>
      </div>
      <h3>
        {resData.data.name}
        </h3>
        ...
        <h3>{resData.data.deliveryTime} mins</h3>
    </div>
  )
}
const Body = () => {
